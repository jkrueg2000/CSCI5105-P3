...
class SyncRequest(_message.Message):
    ...
    item: MarketplaceItem
    primary_id: str
    def __init__(self, item: _Optional[_Union[MarketplaceItem, _Mapping]] = ..., primary_id: _Optional[str] = ...) -> None: ...
...
class StateResponse(_message.Message):
    ...
    all_items: _containers.RepeatedCompositeFieldContainer[MarketplaceItem]
    def __init__(self, all_items: _Optional[_Iterable[_Union[MarketplaceItem, _Mapping]]] = ...) -> None: ...
...
class Ping(_message.Message):
    ...
    class NodeType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        STORAGE: _ClassVar[Ping.NodeType]
